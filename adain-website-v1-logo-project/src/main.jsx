...
function BrandMark({ compact = false }) {
  return (
    <div className={`brand-mark ${compact ? 'compact' : ''}`} aria-label="ada in Project">
      <svg viewBox="0 0 250 82" role="img" aria-label="AIP ada in Project">
        ...
        <text x="70" y="77" fontSize="20" fontFamily="Arial, sans-serif" fontWeight="600" fill="#c99016">Project</text>
      </svg>
    </div>
  );
}
